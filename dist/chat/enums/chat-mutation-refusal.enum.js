...
exports.ChatMutationRefusal = void 0;
/**
 ...
 * decir cuál falló.
 */
var ChatMutationRefusal;
(function (ChatMutationRefusal) {
    /** Quien pregunta no escribió el mensaje. Sólo el autor lo reescribe. */
    ChatMutationRefusal["NOT_THE_AUTHOR"] = "NOT_THE_AUTHOR";
    /** El tipo del mensaje no admite que se rehaga su contenido. */
    ChatMutationRefusal["CONTENT_IS_IMMUTABLE"] = "CONTENT_IS_IMMUTABLE";
    /** El tipo del mensaje no admite que se lo borre. */
    ChatMutationRefusal["MESSAGE_IS_IMMUTABLE"] = "MESSAGE_IS_IMMUTABLE";
    /** Quien pregunta no tiene autoridad sobre ese mensaje en ese chat. */
    ChatMutationRefusal["NOT_AUTHORIZED"] = "NOT_AUTHORIZED";
})(ChatMutationRefusal || (exports.ChatMutationRefusal = ChatMutationRefusal = {}));
