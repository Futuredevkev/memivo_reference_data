...
exports.FOLDER_NAME_FORBIDDEN_CHARACTERS = [
    '/',
    BACKSLASH,
];
/**
 ...
 * carácter a una sola.
 */
exports.FOLDER_NAME_PATTERN = new RegExp('^[^' +
    exports.FOLDER_NAME_FORBIDDEN_CHARACTERS.map((character) => BACKSLASH + character).join('') +
    ']+$');
/** `true` cuando el nombre NO contiene caracteres prohibidos. */
const isValidFolderName = (name) => exports.FOLDER_NAME_PATTERN.test(name);
