...
exports.formatPersonDisplayName = void 0;
/**
 ...
 */
const formatPersonDisplayName = (person) => `${(person.name ?? '').trim()} ${(person.lastName ?? '').trim()}`.trim();
exports.formatPersonDisplayName = formatPersonDisplayName;
