...
export declare const ErrorCode: {
    ...
    readonly BILLING_STORE_UNAVAILABLE: BillingErrorCode.BILLING_STORE_UNAVAILABLE;
    ...
    readonly PLAN_ALBUM_POSTING_REQUIRED: PlanErrorCode.PLAN_ALBUM_POSTING_REQUIRED;
    readonly PLAN_ALBUM_BRANDING_REQUIRED: PlanErrorCode.PLAN_ALBUM_BRANDING_REQUIRED;
    readonly PLAN_ALBUM_PROFESSIONAL_VIDEO_REQUIRED: PlanErrorCode.PLAN_ALBUM_PROFESSIONAL_VIDEO_REQUIRED;
    ...
    readonly MODERATION_CASE_ALREADY_RESOLVED: ModerationErrorCode.MODERATION_CASE_ALREADY_RESOLVED;
    readonly MODERATION_LEGAL_HOLD_TRANSITION_INVALID: ModerationErrorCode.MODERATION_LEGAL_HOLD_TRANSITION_INVALID;
    readonly MODERATED_CONTENT_REMOVAL_FAILED: ModerationErrorCode.MODERATED_CONTENT_REMOVAL_FAILED;
    ...
    readonly CHAT_VIEW_ONCE_OPEN_FAILED: ChatErrorCode.CHAT_VIEW_ONCE_OPEN_FAILED;
    ...
    readonly PROFESSIONAL_VIDEO_TOO_LONG: PhotoErrorCode.PROFESSIONAL_VIDEO_TOO_LONG;
    ...
    readonly USER_PENDING_UPDATE_EXPIRED: UserErrorCode.USER_PENDING_UPDATE_EXPIRED;
