 ...
 */
export declare const MEDIA_AVAILABILITY_CARRIERS: {
    /** Un archivo adjunto a un mensaje del chat. */
    readonly ChatMessageFileResponse: readonly [ResourceType.CHAT_IMAGE, ResourceType.CHAT_VIDEO, ResourceType.CHAT_AUDIO, ResourceType.CHAT_DOCUMENT];
    /** El archivo que se revela al abrir una pieza de una sola vez: imagen o video. */
    readonly OpenViewOnceResponseFile: readonly [ResourceType.CHAT_IMAGE, ResourceType.CHAT_VIDEO];
    /** El archivo de una foto del álbum, sea de invitado o profesional. */
    readonly PhotoFile: readonly [ResourceType.GUEST_PHOTO, ResourceType.GUEST_VIDEO, ResourceType.PROFESSIONAL_PHOTO];
    /** El archivo de una historia. */
    readonly StoryFileInfo: readonly [ResourceType.IMAGE_STORY, ResourceType.VIDEO_STORY];
};
