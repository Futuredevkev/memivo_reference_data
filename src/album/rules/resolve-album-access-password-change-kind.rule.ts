 ...
 */
export const resolveAlbumAccessPasswordChangeKind = (input: {
  /** ¿Había contraseña antes? */
  had: boolean;
  /** ¿Hay contraseña ahora? */
  has: boolean;
}): AlbumAccessPasswordChangeKind => {
  if (!input.has) return 'removed';
