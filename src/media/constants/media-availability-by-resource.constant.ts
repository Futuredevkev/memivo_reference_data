 ...
 * de qué lado cae.
 */
export const MEDIA_AVAILABILITY_BY_RESOURCE: Readonly<
  Record<ResourceType, boolean>
> = {
  [ResourceType.AVATAR]: false,
  [ResourceType.CHAT_GROUP_AVATAR]: false,
  [ResourceType.ALBUM_COVER]: false,
  ...
  [ResourceType.ALBUM_BRANDING_LOGO]: false,
  [ResourceType.PROFILE_REPORT_SCREENSHOT]: false,
  [ResourceType.PROFESSIONAL_PHOTO]: true,
  ...
  [ResourceType.PROFESSIONAL_VIDEO]: true,
  [ResourceType.GUEST_PHOTO]: true,
  [ResourceType.GUEST_VIDEO]: true,
  [ResourceType.CHAT_IMAGE]: true,
  [ResourceType.CHAT_VIDEO]: true,
  [ResourceType.CHAT_AUDIO]: true,
  [ResourceType.CHAT_DOCUMENT]: true,
  [ResourceType.IMAGE_STORY]: true,
  [ResourceType.VIDEO_STORY]: true,
};
