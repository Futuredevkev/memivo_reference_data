 ...
 */
export const MEDIA_AVAILABILITY_CARRIERS = {
  /** Un archivo adjunto a un mensaje del chat. */
  ChatMessageFileResponse: [
    ResourceType.CHAT_IMAGE,
  ...
  OpenViewOnceResponseFile: [ResourceType.CHAT_IMAGE, ResourceType.CHAT_VIDEO],
  /** El archivo de una foto del álbum, sea de invitado o profesional. */
  PhotoFile: [
    ResourceType.GUEST_PHOTO,
    ResourceType.GUEST_VIDEO,
    ResourceType.PROFESSIONAL_PHOTO,
  ],
  /** El archivo de una historia. */
  StoryFileInfo: [ResourceType.IMAGE_STORY, ResourceType.VIDEO_STORY],
} as const satisfies Readonly<Record<string, readonly ResourceType[]>>;
