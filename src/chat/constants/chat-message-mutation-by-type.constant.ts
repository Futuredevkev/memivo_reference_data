import { ChatEditableContent, ChatMessageType } from '../enums';
import type { ChatMessageMutationRule } from '../interfaces';
 ...
 */
export const CHAT_MESSAGE_MUTATION_BY_TYPE: Record<
  ChatMessageType,
  ChatMessageMutationRule
> = {
  // El texto ES el mensaje: rehacerlo es rehacer el mensaje entero.
  [ChatMessageType.TEXT]: {
    edits: ChatEditableContent.TEXT,
    deletable: true,
  },
  /**
  ...
  [ChatMessageType.IMAGE]: {
    edits: ChatEditableContent.NONE,
    deletable: true,
  },
