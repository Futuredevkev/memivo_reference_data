 ...
 */
export const ACTOR_AVATAR_NOTIFICATION_TYPES = new Set<NotificationType>([
  NotificationType.CHAT_INVITATION,
  NotificationType.MEMBER_PROMOTED_ADMIN,
  NotificationType.ALBUM_ORGANIZER_PROMOTED,
  NotificationType.TAGGED_IN_STORY,
  NotificationType.ALBUM_MODERATION_ALERT,
]);
